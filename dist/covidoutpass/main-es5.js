...
/* harmony import */ var ngx_webcam__WEBPACK_IMPORTED_MODULE_25__ = __webpack_require__(/*! ngx-webcam */ "./node_modules/ngx-webcam/fesm5/ngx-webcam.js");
...
var DashboardComponent = /** @class */ (function () {
    function DashboardComponent(router, route, dialog, dataService, snackBar, soundService) {
        this.router = router;
        this.route = route;
        this.dialog = dialog;
    ...
    DashboardComponent.prototype.gotocamera = function () {
    ...
    // }
    DashboardComponent.prototype.regHouse = function () {
        this.router.navigate(['unit']);
    };
    DashboardComponent.prototype.unit = function () {
    ...
    LoginComponent.prototype.login = function () {
        ...
        if (this.loginForm.valid) {
            ...
            this.authService.validateLogin(loginId_1, password).subscribe(function (response) {
                ...
                _this.snackBar.open('Welcome Desuup ' + response.data.username, '', {
                    duration: 5000,
...
var MapComponent = /** @class */ (function () {
    ...
    MapComponent.prototype.getMyLocation = function () {
        var _this = this;
        if (navigator.geolocation) {
            var iconRetinaUrl = 'assets/mymarker.png';
            var iconUrl = 'assets/mymarker.png';
            var iconDefault_1 = leaflet__WEBPACK_IMPORTED_MODULE_2__["icon"]({
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                _this.latitude = position.coords.latitude;
                _this.accuracy = position.coords.accuracy;
                if (_this.accuracy > 100) {
                    leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([_this.latitude, _this.longitude], { icon: iconDefault_1 }).addTo(_this.map)
                        .bindPopup('You are here')
                        .openPopup();
                    _this.map.flyTo([_this.latitude, _this.longitude], 19);
                    ...
                    leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([_this.latitude, _this.longitude], { icon: iconDefault_1 }).addTo(_this.map)
                        .bindPopup('You are here')
                        .openPopup();
                    leaflet__WEBPACK_IMPORTED_MODULE_2__["circle"]([_this.latitude, _this.longitude], {
                        color: '#3498db',
                        fillColor: '#3498db',
                        fillOpacity: 0.3,
                        radius: _this.accuracy
                    }).addTo(_this.map);
                    _this.map.flyTo([_this.latitude, _this.longitude], 19);
                }
    ...
    MapComponent.prototype.getLocation = function () {
        ...
        if (navigator.geolocation) {
            var iconRetinaUrl = 'assets/mymarker.png';
            var iconUrl = 'assets/mymarker.png';
            var iconDefault_2 = leaflet__WEBPACK_IMPORTED_MODULE_2__["icon"]({
                iconRetinaUrl: iconRetinaUrl,
                iconUrl: iconUrl,
                iconSize: [20, 20],
                iconAnchor: [12, 41],
            ...
            navigator.geolocation.getCurrentPosition(function (position) {
                ...
                _this.accuracy = position.coords.accuracy;
                if (_this.accuracy > 100) {
                    leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]([_this.latitude, _this.longitude], { icon: iconDefault_2 }).addTo(_this.map)
                        .bindPopup('You are here')
                        .openPopup();
                    _this.map.flyTo([_this.latitude, _this.longitude], 19);
                    navigator.geolocation.clearWatch(_this.watchId);
    ...
    MapComponent.prototype.renderMap = function () {
        ...
        var tiles = leaflet__WEBPACK_IMPORTED_MODULE_2__["tileLayer"]('https://mt0.google.com/vt/lyrs=s&hl=en&x={x}&y={y}&z={z}', {
            maxZoom: 20,
            minZoom: 13,
            attribution: ''
        });
        ...
        this.map.on('click', function ($e) {
            if (_this.isAddAllowed) {
                if (newMarker !== undefined) {
                    _this.map.removeLayer(newMarker);
                }
                newMarker = leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"]($e.latlng, { icon: _this.myMarker }).addTo(_this.map);
                _this.presentAlert($e.latlng);
            }
        });
    };
    MapComponent.prototype.onMapReady = function (map) {
        ...
        this.http.get(_app_constants__WEBPACK_IMPORTED_MODULE_8__["API_URL"] + "/get-buildings-json/" + zoneId).subscribe(function (json) {
            _this.json = json;
            console.log(json);
            var geoJson = leaflet__WEBPACK_IMPORTED_MODULE_2__["geoJSON"](_this.json, {
                onEachFeature: function (feature, layer) {
                    layer.on('click', function (e) {
                        _this.buildingId = feature.properties.building_id;
                        _this.router.navigate(['dashboard', _this.buildingId]);
                        // this.router.navigate(['dashboard'])
                        _this.snackBar.open('Building number ' + _this.buildingId + ' was successfully selected', '', {
                            duration: 5000,
                            verticalPosition: 'top',
                            panelClass: ['success-snackbar']
                        });
                    ...
                    if (feature.properties.status == 'INCOMPLETE') {
                        return leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"](latLng, { icon: _this.redMarker });
                    }
                    else {
                        return leaflet__WEBPACK_IMPORTED_MODULE_2__["marker"](latLng, { icon: _this.greenMarker });
                    }
                }
            }).addTo(map);
            map.fitBounds(geoJson.getBounds());
    ...
    MapComponent.prototype.toggleAdd = function () {
    ...
    MapComponent.prototype.presentAlert = function (latlng) {
        var _this = this;
        var confirmDialog = this.dialog.open(_confirm_dialog_confirm_dialog_component__WEBPACK_IMPORTED_MODULE_7__["ConfirmDialogComponent"], {
            data: {
                title: 'Confirmation',
        ...
        confirmDialog.afterClosed().subscribe(function (result) {
            if (result === true) {
                _this.building.lat = latlng.lat;
                _this.building.lng = latlng.lng;
                _this.building.sub_zone_id = Number(sessionStorage.getItem('zoneId'));
                _this.dataService.postNewBuilding(_this.building).subscribe(function (response) {
                    console.log(response);
                    _this.buildingId = response.data.id;
                    _this.snackBar.open('Building number ' + _this.buildingId + ' has been successfully identified', '', {
                        duration: 3000,
                        verticalPosition: 'top',
                        panelClass: ['success-snackbar']
                    });
                    if (sessionStorage.getItem('transactionType') === 'registration') {
                        _this.router.navigate(['register', _this.buildingId]);
                    }
                    else {
                        _this.router.navigate(['update-household', _this.buildingId]);
                    }
                });
            }
        });
...
var RegisterUnitComponent = /** @class */ (function () {
    function RegisterUnitComponent(fb, router, dataService, snackBar) {
        this.fb = fb;
        this.router = router;
        this.dataService = dataService;
        this.snackBar = snackBar;
    ...
    RegisterUnitComponent.prototype.ngOnInit = function () {
        this.reactiveForms();
        this.buildingId = Number(sessionStorage.getItem('buildingId'));
    };
    RegisterUnitComponent.prototype.addbuilding = function () {
        this.router.navigate(['dashboard']);
    };
    RegisterUnitComponent.prototype.atmSelect = function (atm, $event) {
        this.atms[atm.id].checked = $event.checked;
    };
    RegisterUnitComponent.prototype.selectUse = function ($event) {
    ...
    RegisterUnitComponent.prototype.submit = function () {
        var _this = this;
        var atmdata = [];
        this.atms.forEach(function (item, index) {
            if (item['checked'] === true) {
                atmdata.push({ "building_id": _this.buildingId, "type": item['name'] });
            }
        });
        ...
        this.dataService.updateBuilding(this.buildingData).subscribe(function (response) {
            if (response.success === "true") {
                if (atmdata.length > 0) {
                    var jsonobjet = {
                        "atms": atmdata
                    };
                    _this.registerAtm(jsonobjet);
                }
                _this.router.navigate(['dashboard', _this.buildingId]);
                _this.snackBar.open('Building registered', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['success-snackbar']
                });
                ...
                _this.snackBar.open('Could not register building' + response.msg, '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
                ...
                _this.snackBar.open('Error registering building', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
    ...
    RegisterUnitComponent.prototype.registerAtm = function (atms) {
        var _this = this;
        this.dataService.postAtms(atms).subscribe(function (response) {
            if (response['success'] === "true") {
                _this.router.navigate(['dashboard', _this.buildingId]);
                _this.snackBar.open('Building registered', '', {
                    duration: 5000,
                ...
                _this.snackBar.open('Building registration error', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
    ...
    RegisterUnitComponent.prototype.reactiveForms = function () {
    ...
    RegisterUnitComponent.ctorParameters = function () { return [
        { type: _angular_forms__WEBPACK_IMPORTED_MODULE_2__["FormBuilder"] },
        { type: _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"] },
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(fb, route, dialog, dataService, router, snackBar) {
        this.fb = fb;
        this.route = route;
        this.dialog = dialog;
        this.dataService = dataService;
    ...
    RegisterComponent.prototype.reactiveForms = function () {
    ...
    RegisterComponent.prototype.selectShopType = function ($event) {
        this.showOtherShopType = false;
    ...
    RegisterComponent.prototype.changeDiff = function ($event) {
        this.displayResdForm = false;
        this.displayShopForm = false;
        this.showOtherType = false;
    ...
    RegisterComponent.prototype.registerUnit = function () {
        var _this = this;
        ...
        this.dataService.postUnit(this.unit).subscribe(function (response) {
            if (response.success === "true") {
                _this.unitId = response.data.id;
                if (_this.unitUse === "Shop") {
                    _this.registerShop(_this.unitId);
                }
                else if (_this.unitUse === "Residential") {
                    _this.registerHousehold(_this.unitId);
                }
                else {
                    _this.snackBar.open('Registration complete', '', {
                        duration: 5000,
                        verticalPosition: 'bottom',
                        panelClass: ['success-snackbar']
                    });
                ...
                _this.snackBar.open('Cannot register unit', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
                ...
                _this.snackBar.open('Error Registering unit', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
    ...
    RegisterComponent.prototype.registerHousehold = function (unitid) {
        var _this = this;
        ...
        this.dataService.postHousehold(this.household).subscribe(function (response) {
            if (response.success === "true") {
                _this.router.navigate(['dashboard', _this.buildingId]);
                _this.snackBar.open('Household Registration Complete', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['success-snackbar']
                });
                ...
                _this.snackBar.open('Could not register Household' + response.msg, '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
                ...
                _this.snackBar.open('Error registering Household', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
    ...
    RegisterComponent.prototype.registerShop = function (unitid) {
        var _this = this;
        ...
        this.dataService.postShop(this.shop).subscribe(function (response) {
            if (response.success === "true") {
                _this.router.navigate(['dashboard', _this.buildingId]);
                _this.snackBar.open('Shop Registration Complete', '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['success-snackbar']
                });
                ...
                _this.snackBar.open('Could not register shop' + response.msg, '', {
                    duration: 5000,
                    verticalPosition: 'bottom',
                    panelClass: ['error-snackbar']
                });
...
var DataService = /** @class */ (function () {
    ...
    DataService.prototype.postAtms = function (items) {
        return this.http
...
var RouteGuard = /** @class */ (function () {
    ...
    RouteGuard.prototype.getUrlWithoutSecondary = function (routerStateSnapshot) {
...
var UploadImageComponent = /** @class */ (function () {
    function UploadImageComponent(router, dataService, snackBar) {
        this.router = router;
        this.dataService = dataService;
        this.snackBar = snackBar;
    ...
    UploadImageComponent.prototype.clearImg = function () {
        this.webcamImage = null;
    };
    UploadImageComponent.prototype.goback = function () {
        this.router.navigate(['dashboard', this.buildingId]);
    };
    UploadImageComponent.prototype.uploadImg = function () {
        var _this = this;
        if (this.webcamImage) {
            var jsonObject = {
            ...
            this.dataService.uploadImg(jsonObject).subscribe(function (response) {
                if (response.success === "true") {
                    _this.router.navigate(['dashboard', _this.buildingId]);
                    _this.snackBar.open('Uploaded Image', '', {
                        duration: 5000,
                        verticalPosition: 'bottom',
                        panelClass: ['success-snackbar']
                    });
                    ...
                    _this.snackBar.open('Could not upload image' + response.msg, '', {
                        duration: 5000,
                        verticalPosition: 'bottom',
                        panelClass: ['error-snackbar']
                    });
                    ...
                    _this.snackBar.open('Error Uploading Image', '', {
                        duration: 5000,
                        verticalPosition: 'bottom',
                        panelClass: ['error-snackbar']
                    });
    ...
    UploadImageComponent.prototype.handleImage = function (webcamImage) {
